// Wedzarnia_optimized_v3.5.ino - Wersja z Bluetooth
#include "config.h"
#include "state.h"
#include "hardware.h"
#include "storage.h"
...
void setup() {
    ...
    Serial.println("Bluetooth: Waiting for connection (Wedzarnia_ESP32)");
    ...
    Serial.printf("Bluetooth: READY (Wedzarnia_ESP32)\n");
    Serial.println("==========================================================\n");
...
void loop() {
    ...
    vTaskDelay(pdMS_TO_TICKS(100)); // Zmniejszone z 1000ms dla szybszej obsługi BT
    
    // Monitoring pamieci co 10 sekund
    static unsigned long loopCounter = 0;
    loopCounter++;
    if (loopCounter % 100 == 0) { // Co 10 sekund (100 * 100ms)
